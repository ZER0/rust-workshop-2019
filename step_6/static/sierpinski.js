...
function generateTetrahedron(p0, p1, p2, p3, level, vertices) {
  if (level == 0) {
    ...
    generateTetrahedron(p0, p01, p02, p03, level - 1, vertices);
    generateTetrahedron(p01, p31, p1, p12, level - 1, vertices);
    generateTetrahedron(p02, p12, p2, p23, level - 1, vertices);
    generateTetrahedron(p03, p23, p3, p31, level - 1, vertices);
  }
}
